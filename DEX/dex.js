const serverUrl = "https://e1yw8hdijpdj.usemoralis.com:2053/server";
const appId = "DmhsqxEJZ7AE8XFK7ahbaJBcvUrfHeXyBDe69k6H";
...
async function formSubmitted(event) {
  ...
  // Submission of the quote requested
  ...
  try {
    ...
    document.querySelector('.js-quote-container').innerHTML = `
    <p class="error">The convertion didn't succeed</p>`;
  }
}  
...
/* To token dropdowns preparation */
